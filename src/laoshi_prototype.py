...
class RealtimeApp(App[None]):
    ...
    async def handle_realtime_connection(self) -> None:
        ...
        When speaking Mandarin Chinese, never use vocabulary above the pre-2021 HSK-3 level under any circumstances. Always use HSK-1, HSK-2 or HSK-3 \
        vocabulary when speaking Mandarin Chinese. Format your responses so that they are concise."
                }
            )
