...
LARGE_LANGUAGE_MODEL = "gpt-realtime-1.5"
...
class RealtimeApp(App[None]):
    ...
    async def handle_realtime_connection(self) -> None:
        async with self.client.realtime.connect(model=LARGE_LANGUAGE_MODEL) as conn:
        ...
        vocabulary outside of HSK-3 under any circumstances. Format your responses so that they are concise. When transcribing \
        Mandarin output, please use Traditional Chinese characters and Hanyu Pinyin (unless the student requests otherwise). \
        When transcribing Cantonese output, please use Traditional Chinese characters and Jyutping (unless the student \
        requests otherwise). Here is the list of HSK-3 words in Traditional Chinese: \
